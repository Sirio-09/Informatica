...
namespace Es_33_Pag_52
{
    internal class Program
    {
        ...
        private static int ControllaAbbondante(int n)
        {
            int i = 1;
            int res = 0;
            do
        ...
        static void Main(string[] args)
        {
            ...
            int res = ControllaAbbondante(n);

            if (res > n)
            {
                Console.WriteLine("Il numero " + n + " è abbondante");
            }
            else
            {
                Console.WriteLine("Il numero " + n + " non è abbondante");
            }
